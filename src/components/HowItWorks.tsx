...
const HowItWorks = () => {
  ...
  const stepsData = [
    ...
    },
    {
      ...
      description: "Apply to positions with a single click and receive guidance on improving your application success.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How Skill Orbit Works</h2>
          <p className="section-subtitle mx-auto">
            A simple three-step process to find your perfect job match.
          </p>
        </div>
