      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Smart Features for <br className="hidden sm:block" />Your Job Search
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Discover how Skill Orbit's AI-powered platform makes finding your ideal job faster and more effective.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Our AI analyzes your skills, experience, and career goals to find opportunities that truly match your professional profile."
            index={0}
          />
          <FeatureCard
            ...
            title="Smart, Fast Recommendations"
            description="Get intelligent job recommendations in seconds, not hours. Our platform continuously learns from your preferences to improve results."
            index={1}
          />
          <FeatureCard
            ...
            description="Discover career paths based on your skills and see what new abilities you need to develop for your dream positions."
            index={2}
          />
          <FeatureCard
            ...
            description="Receive immediate notifications when new jobs matching your profile are posted, giving you a competitive edge in your application."
            index={3}
          />
          <FeatureCard
            ...
            description="We verify all job listings to ensure they're legitimate and high-quality, protecting you from scams and low-value positions."
            index={4}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M12 2v4m0 12v4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M2 12h4m12 0h4M4.93 19.07l2.83-2.83m8.48-8.48l2.83-2.83"></path></svg>}
            title="AI-Powered Insights"
            description="Gain valuable insights into job market trends and your competitive positioning with our advanced AI analysis tools."
            index={5}
          />
        </div>
      </div>
